...
class AmazonDataset(data.Dataset):
    ...
    def __init__(self, file_path, split, reduce=False):
        self.data = pd.read_csv('/Users/michael/PycharmProjects/hebbian-modulated-nlp/clean/amz_{}.csv'.format(split))
...
class YelpDataset(data.Dataset):
    ...
    def __init__(self, file_path, split, reduce=False):
        self.data = pd.read_csv('/Users/michael/PycharmProjects/hebbian-modulated-nlp/clean/yelp_{}.csv'.format(split))
...
class YahooAnswersDataset(data.Dataset):
    ...
    def __init__(self, file_path, split, reduce=False):
        self.data = pd.read_csv('/Users/michael/PycharmProjects/hebbian-modulated-nlp/clean/yahoo_ans_{}.csv'.format(split))
        #
